...
ggsave(file="D://deus_ex_machina/rr/evan_cluster.png", type = "cairo-png", width = 18, height = 15)
...
ggsave(file="D://deus_ex_machina/rr/cathmain_cluster.png", type = "cairo-png", width = 18, height = 15)
...
ggsave(file="D://deus_ex_machina/rr/bprot_cluster.png", type = "cairo-png", width = 18, height = 15)
...
ggsave(file="D://deus_ex_machina/rr/jewish.png", type = "cairo-png", width = 18, height = 15)
...
ggsave(file="D://deus_ex_machina/rr/other_none.png", type = "cairo-png", width = 18, height = 15)
